...
The `app-springboot` quickstart demonstrates how to write a SpringBoot application that is secured with Red Hat SSO.
...
This application also show how to combine Spring Security with Red Hat SSO.
